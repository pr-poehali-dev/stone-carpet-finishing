...
const cityBlocks = [
  { city: 'Краснодаре', text: 'Главный офис и склад материалов находятся в Краснодаре, ул. Красная, 124. Замерщик выезжает по городу бесплатно в день обращения. Делаем каменный ковёр для частных домов, коттеджей, кафе и общественных пространств.' },
  { city: 'Сочи', text: 'Укладываем каменный ковёр в Сочи и на всём Черноморском побережье — Адлер, Хоста, Дагомыс. Покрытие устойчиво к влажному субтропическому климату, не скользит у бассейнов и не выгорает на солнце.' },
  { city: 'Анапе', text: 'Делаем каменный ковёр в Анапе для гостевых домов, отелей и частных участков. Нескользящее покрытие идеально для зон у бассейна и террас на морском воздухе. Выезжаем на замер по согласованию.' },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="reveal max-w-4xl mb-16">
          ...
          <h2 className="font-oswald font-bold mb-6" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', color: 'var(--dark)', lineHeight: 1.0 }}>
            КАМЕННЫЙ КОВЁР <span style={{ color: 'var(--terra)' }}>В КРАСНОДАРЕ, СОЧИ И АНАПЕ</span>
          </h2>
          <div className="space-y-4 font-golos text-base leading-relaxed" style={{ color: 'rgba(26,22,18,0.7)' }}>
            <p>
              <strong>Каменный ковёр</strong> — это современное бесшовное покрытие из натурального камня на полиуретановом связующем. Технология пришла в Россию из Германии и за последние 10 лет стала самым популярным премиальным покрытием для частных домов, бассейнов и общественных пространств в Краснодаре, Сочи, Анапе и по всему Краснодарскому краю.
            </p>
            <p>
              Наша компания <strong>«Каменный Ковёр»</strong> укладывает покрытия из натурального камня в Краснодаре, Сочи, Анапе и Новороссийске с 2014 года. За 12 лет работы мы реализовали более 500 проектов — от небольших крылец до больших террас и обустройства зон вокруг бассейнов. Используем только сертифицированный полиуретан европейского производства и натуральный камень с проверенных карьеров России и Турции.
            </p>
            <p>
        ...
        {/* Каменный ковёр по городам */}
        <div className="reveal mb-16">
          <h3 className="font-oswald font-bold mb-8 uppercase" style={{ fontSize: '1.75rem', color: 'var(--dark)' }}>
            Каменный ковёр в вашем городе
          </h3>
          <div className="grid md:grid-cols-3 gap-4">
            {cityBlocks.map((b, i) => (
              <div key={i} className="p-6" style={{ background: '#fff', border: '1px solid rgba(26,22,18,0.06)', borderRadius: '6px' }}>
                <div className="flex items-center gap-3 mb-3">
                  <Icon name="MapPin" size={18} style={{ color: 'var(--terra)' }} />
                  <h4 className="font-oswald font-semibold text-base uppercase tracking-wide" style={{ color: 'var(--dark)' }}>
                    Каменный ковёр в {b.city}
                  </h4>
                </div>
                <p className="font-golos text-sm leading-relaxed" style={{ color: 'rgba(26,22,18,0.6)' }}>
                  {b.text}
